...
**Browse** - Gallery of 72 HTTP status codes with search, category filtering, bento grid homepage dashboard, and an enhanced "Parrot of the Day" section with fun facts and sharing
...
- **Scenario Practice** (`/practice`) - 51 real-world API scenarios sorted by difficulty (beginner/intermediate/expert) with category filters
- **Debug Exercises** (`/debug`) - 31 "Debug This Response" exercises with broken HTTP exchanges to diagnose, organized by category
...
- **Profile Page** (`/profile`) - View total XP, rank, activity history, and earned badges
...
- **16 Achievement Badges** ("Feathers") - First Flight, Quiz Whiz, Perfect 10, Streak Starter, On Fire, Centurion, Wing Commander, Completionist, Error Expert, Server Sage, Egg Hunter, Scholar, Night Owl, Speed Demon, Frozen Solid, Memory Master
...
- Bento grid homepage dashboard layout
...
There are 1142 automated tests covering routes, API endpoints, security, gamification, and CLI.

## Tech stack

- Python 3.11 / Flask 3.1
- Jinja2 templates with template inheritance (31 templates)
- Custom CSS with glassmorphism, scroll-driven animations, view transitions, seasonal themes, light/dark modes (no framework dependencies)
- Vanilla JavaScript with localStorage-based gamification (no external dependencies)
- 1142 automated tests with 97%+ code coverage
